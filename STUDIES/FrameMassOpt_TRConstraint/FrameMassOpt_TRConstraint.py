...
planar_model.add_design_var('Mass__Frame', lower=0.1, upper=20, ref0=0.1, ref=20)
...
#%%
# Plot the change in design-variable values:
...
# Plot the change in object-function values:
