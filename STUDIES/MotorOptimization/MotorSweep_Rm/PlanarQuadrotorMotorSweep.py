...
def main():
    ...
    attach_recorder(prob, "MotorSweep_965kV_040Rm.sql")
    prob.set_val('kV__Motor', val=965)
    prob.set_val('Rm__Motor', val=0.04)
    run_problem(prob)
    prob.record('final')
    ...
    # Case 3
    prob = initialize(prob, phase)
    attach_recorder(prob, "MotorSweep_965kV_140Rm.sql")
    prob.set_val('kV__Motor', val=965)
    prob.set_val('Rm__Motor', val=0.14)
    run_problem(prob)
    prob.record('final')
