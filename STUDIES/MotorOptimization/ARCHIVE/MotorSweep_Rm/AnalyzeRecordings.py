...
readers = [om.CaseReader(file) for file in ["MotorSweep_965kV_040Rm.sql","MotorSweep_965kV_102Rm.sql", "MotorSweep_965kV_140Rm.sql"]]
cases = [reader.get_case('final') for reader in readers]
lgnd_labels = ["965kV 0.040Rm", "965kV 0.102Rm", "965kV 0.140Rm"]
