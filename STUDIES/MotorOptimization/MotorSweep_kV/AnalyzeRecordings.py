...
readers = [om.CaseReader(file) for file in ["MotorSweep_700kV_102Rm.sql","MotorSweep_965kV_102Rm.sql", "MotorSweep_2550kV_102Rm.sql"]]
cases = [reader.get_case('final') for reader in readers]
lgnd_labels = ["700kV 0.102Rm", "965kV 0.102Rm", "2550kV 0.102Rm"]
