...
init.init_output(__file__, dirname="Output_25")

traj = T.Mission_1(tx=dm.GaussLobatto(num_segments=25, compressed=True))
...
input_opt_path = os.path.join(os.path.dirname(__file__), "..", "InputOptimization", "Output_25")
