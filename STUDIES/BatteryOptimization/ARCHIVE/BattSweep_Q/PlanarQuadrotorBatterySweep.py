...
def main():
    ...
    # Case 3
    prob = initialize(prob, phase)
    attach_recorder(prob, "BattSweep_4S_6000.sql")
    prob.set_val('N_s__Battery', val=4)
