...
phase.set_control_options('u2', val=1, fix_initial=True, fix_final=True)
phase.set_state_options('x1', val=1, fix_initial=True)
phase.set_state_options('x2', val=0, fix_initial=True)
phase.set_state_options('x3', val=0, fix_initial=True)
